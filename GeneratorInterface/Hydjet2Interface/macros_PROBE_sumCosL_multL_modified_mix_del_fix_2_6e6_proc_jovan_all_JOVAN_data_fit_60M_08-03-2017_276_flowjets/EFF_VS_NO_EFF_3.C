...
void DoLegend(){
   ...
   */
   ...
   entry=leg->AddEntry("", "v_{3}{2,|#Delta#eta|>0.8} ALICE","p");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(4);
   ...
   entry=leg->AddEntry("", "v_{3}{2,|#Delta#eta|>2} CMS","p");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(4);
   ...
   entry=leg->AddEntry("", "v_{3}{2,|#Delta#eta|>2}","p");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(4);
   entry->SetMarkerColor(kBlue);
...
void EFF_VS_NO_EFF_3(const char *s, const char *deta){
   ...
   double cms_y21_arr[] = {0.0350503, 0.05043, 0.0646116, 0.0757439};
   double cms_y21_err[] = {5.55521e-05, 9.01159e-05, 0.00014904, 0.000248029};

   double cms_x22_arr[] = {1.25, 1.75, 2.25, 2.75};
   double cms_y22_arr[] = {0.0374497, 0.053992, 0.0689187, 0.0805037};
   double cms_y22_err[] = {8.18305e-05, 0.000132393, 0.000218345, 0.00036662};

   double cms_x23_arr[] = {1.25, 1.75, 2.25, 2.75};
   double cms_y23_arr[] = {0.045248, 0.0646853, 0.0816848, 0.0936034};
   double cms_y23_err[] = {0.000101363, 0.000163843, 0.000267949, 0.000444995};

   double cms_x24_arr[] = {1.25, 1.75, 2.25, 2.75};
   double cms_y24_arr[] = {0.0501976, 0.0710853, 0.0881485, 0.0987511};
   double cms_y24_err[] = {0.000139776, 0.00022669, 0.00037167, 0.0006251};

   double cms_x25_arr[] = {1.25, 1.75, 2.25, 2.75};
   double cms_y25_arr[] = {0.0533016, 0.0746843, 0.0904531, 0.0987475};
   double cms_y25_err[] = {0.0002524, 0.000347277, 0.000575679, 0.000984717};
   
   double cms_x26_arr[] = {1.25, 1.75, 2.25, 2.75};
   double cms_y26_arr[] = {0.0540148, 0.0743504, 0.0886991, 0.0936197};
   double cms_y26_err[] = {0.000178493, 0.00029528, 0.000500802, 0.000844007};
   
   double cms_x27_arr[] = {1.25, 1.75, 2.25, 2.75};
   double cms_y27_arr[] = {0.0501319, 0.0671415, 0.077871, 0.0800868};
   double cms_y27_err[] = {0.000367971, 0.000624851, 0.00108313, 0.00167361};
   ...
   */
   ...
   //PlotData( pt0, INPUT["np_mode1_UCC"+ext2], INPUT["np_mode1_UCC_error"+ext2], kViolet, 25, 1.1, "p" );
   //PlotData( pt0, INPUT["np_mode2_UCC"+ext2], INPUT["np_mode2_UCC_error"+ext2], kMagenta, 25, 1.1, "p" );
   ...
   //PlotData( pt1, INPUT["np_mode1_00_05"+ext2], INPUT["np_mode1_00_05_error"+ext2], kViolet, 25, 1.1, "p" );
   //PlotData( pt1, INPUT["np_mode2_00_05"+ext2], INPUT["np_mode2_00_05_error"+ext2], kMagenta, 25, 1.1, "p" );
   ...
   //PlotData( pt2, INPUT["np_mode1_00_10"+ext2], INPUT["np_mode1_00_10_error"+ext2], kViolet, 25, 1.1, "p" );
   //PlotData( pt2, INPUT["np_mode2_00_10"+ext2], INPUT["np_mode2_00_10_error"+ext2], kMagenta, 25, 1.1, "p" );
   ...
   //PlotData( pt3, INPUT["np_mode1_10_20"+ext2], INPUT["np_mode1_10_20_error"+ext2], kViolet, 25, 1.1, "p" );
   //PlotData( pt3, INPUT["np_mode2_10_20"+ext2], INPUT["np_mode2_10_20_error"+ext2], kMagenta, 25, 1.1, "p" );
