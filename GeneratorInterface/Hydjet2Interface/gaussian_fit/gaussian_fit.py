...
cases = []
with open(indir+'cases.txt', 'r') as cfile:
    cases = cfile.read()[:-1].split(' ')

centralities = []
with open(indir+'centralities.txt', 'r') as cfile:
    centralities = cfile.read()[:-1].split(' ')

ocentralities = []
with open(indir+'ocentralities.txt', 'r') as cfile:
...
WWW='/afs/cern.ch/user/c/cirkovic/www/02-11-2016_gf/'
