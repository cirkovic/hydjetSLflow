...
def main():
       ...
       sub_fol2 = root_file.mkdir("mode_5");
       root_file.cd("mode_5")

       pull_mode5 = ROOT.TH1F("lambda5","#lambda_{5}", 30000, -10, 100)

       pull_mode5.GetXaxis().SetTitle("#lambda_{5}")
       pull_mode5.GetXaxis().SetTitleOffset(1.3)


       sub_fol2 = root_file.mkdir("mode_6");
       root_file.cd("mode_6")

       pull_mode6 = ROOT.TH1F("lambda6","#lambda_{6}", 30000, -10, 100)

       pull_mode6.GetXaxis().SetTitle("#lambda_{6}")
       pull_mode6.GetXaxis().SetTitleOffset(1.3)


       sub_fol2 = root_file.mkdir("mode_7");
       root_file.cd("mode_7")

       pull_mode7 = ROOT.TH1F("lambda7","#lambda_{7}", 30000, -10, 100)
