...
def main():
       ...
       #pull_mode4.SetFillColor(39)

       sub_fol1 = root_file.mkdir("mode_5");
       root_file.cd("mode_5")

       pull_mode5 = ROOT.TH1F("lambda5","#lambda_{5}", 10000, -1.5, 50)

       pull_mode5.GetXaxis().SetTitle("#lambda_{5}")
       pull_mode5.GetXaxis().SetTitleOffset(1.3)
       #pull_mode5.SetFillColor(39)


       sub_fol1 = root_file.mkdir("mode_6");
       root_file.cd("mode_6")

       pull_mode6 = ROOT.TH1F("lambda6","#lambda_{6}", 5000, -1.5, 100)

       pull_mode6.GetXaxis().SetTitle("#lambda_{6}")
       pull_mode6.GetXaxis().SetTitleOffset(1.3)
       #pull_mode6.SetFillColor(39)

       sub_fol7 = root_file.mkdir("mode_7");
       root_file.cd("mode_7")

       pull_mode7 = ROOT.TH1F("lambda7","#lambda_{7}", 10000, -1.5, 50)

       pull_mode7.GetXaxis().SetTitle("#lambda_{7}")
       pull_mode7.GetXaxis().SetTitleOffset(1.3)
       #pull_mode7.SetFillColor(39)
...
#           eigenvectors=dict()
           ...
           pull_mode5.Fill(eigenvalues[5])
           pull_mode6.Fill(eigenvalues[6])
           pull_mode7.Fill(eigenvalues[7])
       ...
       simulated_eigenvalues["5"]=pull_mode5.GetMean()
       simulated_eigenvalues["6"]=pull_mode6.GetMean()
       simulated_eigenvalues["7"]=pull_mode7.GetMean()
       ...
       simulated_eigenvalues_errors["5"]=pull_mode5.GetRMS()
       simulated_eigenvalues_errors["6"]=pull_mode6.GetRMS()
       simulated_eigenvalues_errors["7"]=pull_mode7.GetRMS()
