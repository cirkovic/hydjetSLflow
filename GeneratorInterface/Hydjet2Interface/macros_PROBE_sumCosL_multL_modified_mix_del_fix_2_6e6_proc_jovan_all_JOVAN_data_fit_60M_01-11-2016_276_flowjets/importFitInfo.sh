...
for cas in `cat cases.txt`; do
    for cent in `cat ocentralities.txt`; do
        cp ${INPUT}/fout_${cas}_${cent}_2.json FIT/${cas}/2.0/n2/${cent}.json
        cp ${INPUT}/fout_${cas}_${cent}_3.json FIT/${cas}/2.0/n3/${cent}.json
    done
done
