...
void EFF_VS_NO_EFF_3(const char *s1, const char *deta1, const char *s2, const char *deta2){
   ...
   */
   ...
   // UCC
   document=READFILE((string("./DATA_flow/")+string(s1)+string("_np/")+string(deta1)+string("/n3/00_02.json")).c_str());
   ...
   // 0-5
   document=READFILE((string("./DATA_flow/")+string(s1)+string("_np/")+string(deta1)+string("/n3/00_05.json")).c_str());
   ...
   // 0-10
   document=READFILE((string("./DATA_flow/")+string(s1)+string("_np/")+string(deta1)+string("/n3/00_10.json")).c_str());
   ...
   // 10-20
   document=READFILE((string("./DATA_flow/")+string(s1)+string("_np/")+string(deta1)+string("/n3/10_20.json")).c_str());
   ...
   // 20-30
   document=READFILE((string("./DATA_flow/")+string(s1)+string("_np/")+string(deta1)+string("/n3/20_30.json")).c_str());
   ...
   // 30-40
   document=READFILE((string("./DATA_flow/")+string(s1)+string("_np/")+string(deta1)+string("/n3/30_40.json")).c_str());
   ...
   /////////////////////////////////////////////////////
   // 40-50
   document=READFILE((string("./DATA_flow/")+string(s1)+string("_np/")+string(deta1)+string("/n3/40_50.json")).c_str());
   ...
   // 50-60
   document=READFILE((string("./DATA_flow/")+string(s1)+string("_np/")+string(deta1)+string("/n3/50_60.json")).c_str());
