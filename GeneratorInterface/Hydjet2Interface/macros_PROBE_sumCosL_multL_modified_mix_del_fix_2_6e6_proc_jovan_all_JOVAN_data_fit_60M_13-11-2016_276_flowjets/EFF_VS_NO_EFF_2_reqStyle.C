...
void DoLegend(){
   ...
   TLegend *leg = new TLegend(0.3, 0.18, 0.9, 0.48, NULL,"brNDC");
   leg->SetBorderSize(0);
...
void EFF_VS_NO_EFF_2(const char *s, const char *deta){
   ...
   */
   ...
   PlotData( pt0, INPUT["fit_UCC"+ext1], INPUT["fit_UCC_error"+ext1], kBlack, 5, 2.0, "p" );
   ...
   PlotData( pt1, INPUT["fit_00_05"+ext1], INPUT["fit_00_05_error"+ext1], kBlack, 5, 2.0, "p" );
   ...
   PlotData( pt2, INPUT["fit_00_10"+ext1], INPUT["fit_00_10_error"+ext1], kBlack, 5, 2.0, "p" );
   ...
   PlotData( pt3, INPUT["fit_10_20"+ext1], INPUT["fit_10_20_error"+ext1], kBlack, 5, 2.0, "p" );
   ...
   PlotData( pt4, INPUT["fit_20_30"+ext1], INPUT["fit_20_30_error"+ext1], kBlack, 5, 2.0, "p" );
   ...
   PlotData( pt5, INPUT["fit_30_40"+ext1], INPUT["fit_30_40_error"+ext1], kBlack, 5, 2.0, "p" );
   ...
   PlotData( pt6, INPUT["fit_40_50"+ext1], INPUT["fit_40_50_error"+ext1], kBlack, 5, 2.0, "p" );
   ...
   PlotData( pt7, INPUT["fit_50_60"+ext1], INPUT["fit_50_60_error"+ext1], kBlack, 5, 2.0, "p" );
