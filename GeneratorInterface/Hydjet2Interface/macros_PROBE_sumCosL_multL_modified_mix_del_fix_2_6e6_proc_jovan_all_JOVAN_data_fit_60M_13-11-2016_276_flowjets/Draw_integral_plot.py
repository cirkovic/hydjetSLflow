...
for n in ["n2", "n3"]:
    ...
    for mode in ["mode1", "mode2"]:
        ...
        hs.append(TH1F(n+"_"+mode, n+"_"+mode, 670, -5.0, 62.0))
        hs[-1].Sumw2()
        print n+"_"+mode
...
for ni, n in enumerate(["n2", "n3"]):
    ...
    if ni == 1:
        ...
        hs[ni*3+2].GetXaxis().SetLabelSize(hs[ni*3+2].GetXaxis().GetLabelSize()*2.0*1.2)
    else:
        #hs[ni*3+2].GetXaxis().SetLabelSize(0)
        hs[ni*3+2].GetXaxis().SetLabelSize(0)
    #hs[ni*3+2].GetYaxis().SetLabelSize(hs[ni*3+2].GetYaxis().GetLabelSize()*2.0)
    hs[ni*3+2].GetYaxis().SetLabelSize(hs[ni*3+2].GetYaxis().GetLabelSize()*2.0*1.2)
