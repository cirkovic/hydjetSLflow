...
void DoLegend(){
   ...
   //TLegend *leg = new TLegend(0.175, 0.18, 0.9, 0.48, NULL,"brNDC");
...
void DoText(TString text){
   ...
   //TText *t = new TText(2.5,lvpos, text);
   //t->SetTextAlign(22);
...
void EFF_VS_NO_EFF_2(const char *s1, const char *deta1, const char *s2, const char *deta2){
   ...
   */
   ...
   // UCC
   document_np=READFILE((string("./DATA_flowjets/")+string(s1)+string("_np/")+string(deta1)+string("/n2/00_02.json")).c_str());
   ...
   */
   ...
   // 0-5
   document_np=READFILE((string("./DATA_flowjets/")+string(s1)+string("_np/")+string(deta1)+string("/n2/00_05.json")).c_str());
   ...
   */
   ...
   // 0-10
   document_np=READFILE((string("./DATA_flowjets/")+string(s1)+string("_np/")+string(deta1)+string("/n2/00_10.json")).c_str());
   ...
   */
   ...
   // 10-20
   document_np=READFILE((string("./DATA_flowjets/")+string(s1)+string("_np/")+string(deta1)+string("/n2/10_20.json")).c_str());
   ...
   */
   ...
   // 20-30
   document_np=READFILE((string("./DATA_flowjets/")+string(s1)+string("_np/")+string(deta1)+string("/n2/20_30.json")).c_str());
   ...
   */
   ...
   // 30-40
   document_np=READFILE((string("./DATA_flowjets/")+string(s1)+string("_np/")+string(deta1)+string("/n2/30_40.json")).c_str());
   ...
   */
   ...
   // 40-50
   document_np=READFILE((string("./DATA_flowjets/")+string(s1)+string("_np/")+string(deta1)+string("/n2/40_50.json")).c_str());
   ...
   */
   ...
   // 50-60
   document_np=READFILE((string("./DATA_flowjets/")+string(s1)+string("_np/")+string(deta1)+string("/n2/50_60.json")).c_str());
   ...
   */
   ...
   // UCC
   document_np=READFILE((string("./DATA_flow/")+string(s2)+string("_np/")+string(deta1)+string("/n2/00_02.json")).c_str());
   document=READFILE((string("./DATA_flow/")+string(s2)+string("/")+string(deta1)+string("/n2/00_02.json")).c_str());
   ...
   */
   ...
   // 0-5
   document_np=READFILE((string("./DATA_flow/")+string(s2)+string("_np/")+string(deta1)+string("/n2/00_05.json")).c_str());
   document=READFILE((string("./DATA_flow/")+string(s2)+string("/")+string(deta1)+string("/n2/00_05.json")).c_str());
   ...
   */
   ...
   // 0-10
   document_np=READFILE((string("./DATA_flow/")+string(s2)+string("_np/")+string(deta1)+string("/n2/00_10.json")).c_str());
   document=READFILE((string("./DATA_flow/")+string(s2)+string("/")+string(deta1)+string("/n2/00_10.json")).c_str());
   ...
   */
   ...
   // 10-20
   document_np=READFILE((string("./DATA_flow/")+string(s2)+string("_np/")+string(deta1)+string("/n2/10_20.json")).c_str());
   document=READFILE((string("./DATA_flow/")+string(s2)+string("/")+string(deta1)+string("/n2/10_20.json")).c_str());
   ...
   */
   ...
   // 20-30
   document_np=READFILE((string("./DATA_flow/")+string(s2)+string("_np/")+string(deta1)+string("/n2/20_30.json")).c_str());
   document=READFILE((string("./DATA_flow/")+string(s2)+string("/")+string(deta1)+string("/n2/20_30.json")).c_str());
   ...
   */
   ...
   // 30-40
   document_np=READFILE((string("./DATA_flow/")+string(s2)+string("_np/")+string(deta1)+string("/n2/30_40.json")).c_str());
   document=READFILE((string("./DATA_flow/")+string(s2)+string("/")+string(deta1)+string("/n2/30_40.json")).c_str());
   ...
   */
   ...
   /////////////////////////////////////////////////////
   // 40-50
   document_np=READFILE((string("./DATA_flow/")+string(s2)+string("_np/")+string(deta1)+string("/n2/40_50.json")).c_str());
   document=READFILE((string("./DATA_flow/")+string(s2)+string("/")+string(deta1)+string("/n2/40_50.json")).c_str());
   ...
   */
   ...
   // 50-60
   document_np=READFILE((string("./DATA_flow/")+string(s2)+string("_np/")+string(deta1)+string("/n2/50_60.json")).c_str());
   document=READFILE((string("./DATA_flow/")+string(s2)+string("/")+string(deta1)+string("/n2/50_60.json")).c_str());
   ...
   */
   ...
   //DoLatex(0.275, 0.53, "#scale[1.0]{HYDJET++}");//position, text
   DoLatex(0.68, 0.61, "#scale[1.1]{HYDJET++}");//position, text
   //DoLatex(0.275, 0.46, "#scale[1.0]{PbPb #sqrt{s_{NN}} = 2.76 TeV}");//position, text
