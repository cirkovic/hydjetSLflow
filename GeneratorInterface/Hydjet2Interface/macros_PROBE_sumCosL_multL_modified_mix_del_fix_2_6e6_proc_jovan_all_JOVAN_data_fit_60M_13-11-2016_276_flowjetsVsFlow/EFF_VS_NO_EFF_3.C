...
void DoLegend(){
   ...
   TLegend *leg = new TLegend(0.27, 0.19, 0.77, 0.49, NULL, "brNDC");
   leg->SetBorderSize(0);
   ...
   */
   ...
   entry=leg->AddEntry((TObject*)0, "flow + quenched jets:","");
   ...
   entry=leg->AddEntry((TObject*)0, "pure flow:","");
   ...
   /*
   entry=leg->AddEntry("", "flow+jets fit","p");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(4);
...
void EFF_VS_NO_EFF_3(const char *s1, const char *deta1, const char *s2, const char *deta2){
   ...
   */
   ...
   // UCC
   document_np=READFILE((string("./DATA_flowjets/")+string(s1)+string("_np/")+string(deta1)+string("/n3/00_02.json")).c_str());
   document=READFILE((string("./DATA_flowjets/")+string(s1)+string("/")+string(deta1)+string("/n3/00_02.json")).c_str());
   INPUT["flowjets_mode1_UCC"+ext1]=ReadData(document_np, "mode1");
   INPUT["flowjets_mode1_UCC_error"+ext1]=ReadData(document, "mode1_error");
   INPUT["flowjets_mode2_UCC"+ext1]=ReadData(document_np, "mode2");
   INPUT["flowjets_mode2_UCC_error"+ext1]=ReadData(document, "mode2_error");
   /*
   document=READFILE((string("./FIT_flowjets/")+string(s1)+string("/")+string(deta1)+string("/n3/00_02.json")).c_str());
   INPUT["flowjets_fit_UCC"+ext1]=ReadData(document, "mode1");
   INPUT["flowjets_fit_UCC_error"+ext1]=ReadData(document, "mode1_error");
   */

   // 0-5
   document_np=READFILE((string("./DATA_flowjets/")+string(s1)+string("_np/")+string(deta1)+string("/n3/00_05.json")).c_str());
   document=READFILE((string("./DATA_flowjets/")+string(s1)+string("/")+string(deta1)+string("/n3/00_05.json")).c_str());
   INPUT["flowjets_mode1_00_05"+ext1]=ReadData(document_np, "mode1");
   INPUT["flowjets_mode1_00_05_error"+ext1]=ReadData(document, "mode1_error");
   INPUT["flowjets_mode2_00_05"+ext1]=ReadData(document_np, "mode2");
   INPUT["flowjets_mode2_00_05_error"+ext1]=ReadData(document, "mode2_error");
   /*
   document=READFILE((string("./FIT_flowjets/")+string(s1)+string("/")+string(deta1)+string("/n3/00_05.json")).c_str());
   ...
   */
   ...
   // 0-10
   document_np=READFILE((string("./DATA_flowjets/")+string(s1)+string("_np/")+string(deta1)+string("/n3/00_10.json")).c_str());
   document=READFILE((string("./DATA_flowjets/")+string(s1)+string("/")+string(deta1)+string("/n3/00_10.json")).c_str());
   INPUT["flowjets_mode1_00_10"+ext1]=ReadData(document_np, "mode1");
   INPUT["flowjets_mode1_00_10_error"+ext1]=ReadData(document, "mode1_error");
   INPUT["flowjets_mode2_00_10"+ext1]=ReadData(document_np, "mode2");
   INPUT["flowjets_mode2_00_10_error"+ext1]=ReadData(document, "mode2_error");
   /*
   document=READFILE((string("./FIT_flowjets/")+string(s1)+string("/")+string(deta1)+string("/n3/00_10.json")).c_str());
   ...
   */
   ...
   // 10-20
   document_np=READFILE((string("./DATA_flowjets/")+string(s1)+string("_np/")+string(deta1)+string("/n3/10_20.json")).c_str());
   document=READFILE((string("./DATA_flowjets/")+string(s1)+string("/")+string(deta1)+string("/n3/10_20.json")).c_str());
   INPUT["flowjets_mode1_10_20"+ext1]=ReadData(document_np, "mode1");
   INPUT["flowjets_mode1_10_20_error"+ext1]=ReadData(document, "mode1_error");
   INPUT["flowjets_mode2_10_20"+ext1]=ReadData(document_np, "mode2");
   INPUT["flowjets_mode2_10_20_error"+ext1]=ReadData(document, "mode2_error");
   /*
   document=READFILE((string("./FIT_flowjets/")+string(s1)+string("/")+string(deta1)+string("/n3/10_20.json")).c_str());
   ...
   */
   ...
   // 20-30
   document_np=READFILE((string("./DATA_flowjets/")+string(s1)+string("_np/")+string(deta1)+string("/n3/20_30.json")).c_str());
   document=READFILE((string("./DATA_flowjets/")+string(s1)+string("/")+string(deta1)+string("/n3/20_30.json")).c_str());
   INPUT["flowjets_mode1_20_30"+ext1]=ReadData(document_np, "mode1");
   INPUT["flowjets_mode1_20_30_error"+ext1]=ReadData(document, "mode1_error");
   INPUT["flowjets_mode2_20_30"+ext1]=ReadData(document_np, "mode2");
   INPUT["flowjets_mode2_20_30_error"+ext1]=ReadData(document, "mode2_error");
   /*
   document=READFILE((string("./FIT_flowjets/")+string(s1)+string("/")+string(deta1)+string("/n3/20_30.json")).c_str());
   ...
   */
   ...
   // 30-40
   document_np=READFILE((string("./DATA_flowjets/")+string(s1)+string("_np/")+string(deta1)+string("/n3/30_40.json")).c_str());
   document=READFILE((string("./DATA_flowjets/")+string(s1)+string("/")+string(deta1)+string("/n3/30_40.json")).c_str());
   INPUT["flowjets_mode1_30_40"+ext1]=ReadData(document_np, "mode1");
   INPUT["flowjets_mode1_30_40_error"+ext1]=ReadData(document, "mode1_error");
   INPUT["flowjets_mode2_30_40"+ext1]=ReadData(document_np, "mode2");
   INPUT["flowjets_mode2_30_40_error"+ext1]=ReadData(document, "mode2_error");
   /*
   document=READFILE((string("./FIT_flowjets/")+string(s1)+string("/")+string(deta1)+string("/n3/30_40.json")).c_str());
   ...
   */
   ...
   // 40-50
   document_np=READFILE((string("./DATA_flowjets/")+string(s1)+string("_np/")+string(deta1)+string("/n3/40_50.json")).c_str());
   document=READFILE((string("./DATA_flowjets/")+string(s1)+string("/")+string(deta1)+string("/n3/40_50.json")).c_str());
   INPUT["flowjets_mode1_40_50"+ext1]=ReadData(document_np, "mode1");
   INPUT["flowjets_mode1_40_50_error"+ext1]=ReadData(document, "mode1_error");
   INPUT["flowjets_mode2_40_50"+ext1]=ReadData(document_np, "mode2");
   INPUT["flowjets_mode2_40_50_error"+ext1]=ReadData(document, "mode2_error");
   /*
   document=READFILE((string("./FIT_flowjets/")+string(s1)+string("/")+string(deta1)+string("/n3/40_50.json")).c_str());
   ...
   */
   ...
   // 50-60
   document_np=READFILE((string("./DATA_flowjets/")+string(s1)+string("_np/")+string(deta1)+string("/n3/50_60.json")).c_str());
   document=READFILE((string("./DATA_flowjets/")+string(s1)+string("/")+string(deta1)+string("/n3/50_60.json")).c_str());
   INPUT["flowjets_mode1_50_60"+ext1]=ReadData(document_np, "mode1");
   INPUT["flowjets_mode1_50_60_error"+ext1]=ReadData(document, "mode1_error");
   INPUT["flowjets_mode2_50_60"+ext1]=ReadData(document_np, "mode2");
   INPUT["flowjets_mode2_50_60_error"+ext1]=ReadData(document, "mode2_error");
   /*
   document=READFILE((string("./FIT_flowjets/")+string(s1)+string("/")+string(deta1)+string("/n3/50_60.json")).c_str());
   ...
   */
   ...
   // UCC
   document_np=READFILE((string("./DATA_flow/")+string(s2)+string("_np/")+string(deta1)+string("/n3/00_02.json")).c_str());
   document=READFILE((string("./DATA_flow/")+string(s2)+string("/")+string(deta1)+string("/n3/00_02.json")).c_str());
   INPUT["flow_mode1_UCC"+ext1]=ReadData(document_np, "mode1");
   INPUT["flow_mode1_UCC_error"+ext1]=ReadData(document, "mode1_error");
   INPUT["flow_mode2_UCC"+ext1]=ReadData(document_np, "mode2");
   INPUT["flow_mode2_UCC_error"+ext1]=ReadData(document, "mode2_error");
   /*
   document=READFILE((string("./FIT_flow/")+string(s1)+string("/")+string(deta1)+string("/n3/00_02.json")).c_str());
   INPUT["flow_fit_UCC"+ext1]=ReadData(document, "mode1");
   INPUT["flow_fit_UCC_error"+ext1]=ReadData(document, "mode1_error");
   */

   // 0-5
   document_np=READFILE((string("./DATA_flow/")+string(s2)+string("_np/")+string(deta1)+string("/n3/00_05.json")).c_str());
   document=READFILE((string("./DATA_flow/")+string(s2)+string("/")+string(deta1)+string("/n3/00_05.json")).c_str());
   INPUT["flow_mode1_00_05"+ext1]=ReadData(document_np, "mode1");
   INPUT["flow_mode1_00_05_error"+ext1]=ReadData(document, "mode1_error");
   INPUT["flow_mode2_00_05"+ext1]=ReadData(document_np, "mode2");
   INPUT["flow_mode2_00_05_error"+ext1]=ReadData(document, "mode2_error");
   /*
   document=READFILE((string("./FIT_flow/")+string(s1)+string("/")+string(deta1)+string("/n3/00_05.json")).c_str());
   ...
   */
   ...
   // 0-10
   document_np=READFILE((string("./DATA_flow/")+string(s2)+string("_np/")+string(deta1)+string("/n3/00_10.json")).c_str());
   document=READFILE((string("./DATA_flow/")+string(s2)+string("/")+string(deta1)+string("/n3/00_10.json")).c_str());
   INPUT["flow_mode1_00_10"+ext1]=ReadData(document_np, "mode1");
   INPUT["flow_mode1_00_10_error"+ext1]=ReadData(document, "mode1_error");
   INPUT["flow_mode2_00_10"+ext1]=ReadData(document_np, "mode2");
   INPUT["flow_mode2_00_10_error"+ext1]=ReadData(document, "mode2_error");
   /*
   document=READFILE((string("./FIT_flow/")+string(s1)+string("/")+string(deta1)+string("/n3/00_10.json")).c_str());
   ...
   */
   ...
   // 10-20
   document_np=READFILE((string("./DATA_flow/")+string(s2)+string("_np/")+string(deta1)+string("/n3/10_20.json")).c_str());
   document=READFILE((string("./DATA_flow/")+string(s2)+string("/")+string(deta1)+string("/n3/10_20.json")).c_str());
   INPUT["flow_mode1_10_20"+ext1]=ReadData(document_np, "mode1");
   INPUT["flow_mode1_10_20_error"+ext1]=ReadData(document, "mode1_error");
   INPUT["flow_mode2_10_20"+ext1]=ReadData(document_np, "mode2");
   INPUT["flow_mode2_10_20_error"+ext1]=ReadData(document, "mode2_error");
   /*
   document=READFILE((string("./FIT_flow/")+string(s1)+string("/")+string(deta1)+string("/n3/10_20.json")).c_str());
   ...
   */
   ...
   // 20-30
   document_np=READFILE((string("./DATA_flow/")+string(s2)+string("_np/")+string(deta1)+string("/n3/20_30.json")).c_str());
   document=READFILE((string("./DATA_flow/")+string(s2)+string("/")+string(deta1)+string("/n3/20_30.json")).c_str());
   INPUT["flow_mode1_20_30"+ext1]=ReadData(document_np, "mode1");
   INPUT["flow_mode1_20_30_error"+ext1]=ReadData(document, "mode1_error");
   INPUT["flow_mode2_20_30"+ext1]=ReadData(document_np, "mode2");
   INPUT["flow_mode2_20_30_error"+ext1]=ReadData(document, "mode2_error");
   /*
   document=READFILE((string("./FIT_flow/")+string(s1)+string("/")+string(deta1)+string("/n3/20_30.json")).c_str());
   ...
   */
   ...
   // 30-40
   document_np=READFILE((string("./DATA_flow/")+string(s2)+string("_np/")+string(deta1)+string("/n3/30_40.json")).c_str());
   document=READFILE((string("./DATA_flow/")+string(s2)+string("/")+string(deta1)+string("/n3/30_40.json")).c_str());
   INPUT["flow_mode1_30_40"+ext1]=ReadData(document_np, "mode1");
   INPUT["flow_mode1_30_40_error"+ext1]=ReadData(document, "mode1_error");
   INPUT["flow_mode2_30_40"+ext1]=ReadData(document_np, "mode2");
   INPUT["flow_mode2_30_40_error"+ext1]=ReadData(document, "mode2_error");
   /*
   document=READFILE((string("./FIT_flow/")+string(s1)+string("/")+string(deta1)+string("/n3/30_40.json")).c_str());
   ...
   */
   ...
   /////////////////////////////////////////////////////
   // 40-50
   document_np=READFILE((string("./DATA_flow/")+string(s2)+string("_np/")+string(deta1)+string("/n3/40_50.json")).c_str());
   document=READFILE((string("./DATA_flow/")+string(s2)+string("/")+string(deta1)+string("/n3/40_50.json")).c_str());
   INPUT["flow_mode1_40_50"+ext1]=ReadData(document_np, "mode1");
   INPUT["flow_mode1_40_50_error"+ext1]=ReadData(document, "mode1_error");
   INPUT["flow_mode2_40_50"+ext1]=ReadData(document_np, "mode2");
   INPUT["flow_mode2_40_50_error"+ext1]=ReadData(document, "mode2_error");
   /*
   document=READFILE((string("./FIT_flow/")+string(s1)+string("/")+string(deta1)+string("/n3/40_50.json")).c_str());
   ...
   */
   ...
   // 50-60
   document_np=READFILE((string("./DATA_flow/")+string(s2)+string("_np/")+string(deta1)+string("/n3/50_60.json")).c_str());
   document=READFILE((string("./DATA_flow/")+string(s2)+string("/")+string(deta1)+string("/n3/50_60.json")).c_str());
   INPUT["flow_mode1_50_60"+ext1]=ReadData(document_np, "mode1");
   INPUT["flow_mode1_50_60_error"+ext1]=ReadData(document, "mode1_error");
   INPUT["flow_mode2_50_60"+ext1]=ReadData(document_np, "mode2");
   INPUT["flow_mode2_50_60_error"+ext1]=ReadData(document, "mode2_error");
   /*
   document=READFILE((string("./FIT_flow/")+string(s1)+string("/")+string(deta1)+string("/n3/50_60.json")).c_str());
   ...
   */
   ...
   //DoLatex(0.275, 0.53, "#scale[0.9]{HYDJET++: PbPb #sqrt{s_{NN}} = 2.76 TeV}");//position, tex
   ...
   PlotData( pt0, INPUT["flow_mode1_UCC"+ext1], INPUT["flow_mode1_UCC_error"+ext1], kBlue, 26, 1.5, "p" );
   PlotData( pt0, INPUT["flow_mode2_UCC"+ext1], INPUT["flow_mode2_UCC_error"+ext1], kRed, 32, 1.5, "p" );
   //PlotData( pt0, INPUT["flow_fit_UCC"+ext1], INPUT["flow_fit_UCC_error"+ext1], kCyan, 34, 1.1, "p" );

   //PlotData( pt0, INPUT["flowjets_mode1_UCC"+ext2], INPUT["flowjets_mode1_UCC_error"+ext2], kRed, 32, 1.5, "p" );
   ...
   PlotData( pt1, INPUT["flow_mode1_00_05"+ext1], INPUT["flow_mode1_00_05_error"+ext1], kBlue, 26, 1.5, "p" );
   PlotData( pt1, INPUT["flow_mode2_00_05"+ext1], INPUT["flow_mode2_00_05_error"+ext1], kRed, 32, 1.5, "p" );
   //PlotData( pt1, INPUT["flow_fit_00_05"+ext1], INPUT["flow_fit_00_05_error"+ext1], kCyan, 34, 1.1, "p" );

   //PlotData( pt1, INPUT["flowjets_mode1_00_05"+ext2], INPUT["flowjets_mode1_00_05_error"+ext2], kRed, 32, 1.5, "p" );
   ...
   PlotData( pt2, INPUT["flow_mode1_00_10"+ext1], INPUT["flow_mode1_00_10_error"+ext1], kBlue, 26, 1.5, "p" );
   PlotData( pt2, INPUT["flow_mode2_00_10"+ext1], INPUT["flow_mode2_00_10_error"+ext1], kRed, 32, 1.5, "p" );
   //PlotData( pt2, INPUT["flow_fit_00_10"+ext1], INPUT["flow_fit_00_10_error"+ext1], kCyan, 34, 1.1, "p" );

   //PlotData( pt2, INPUT["flowjets_mode1_00_10"+ext2], INPUT["flowjets_mode1_00_10_error"+ext2], kRed, 32, 1.5, "p" );
   ...
   PlotData( pt3, INPUT["flow_mode1_10_20"+ext1], INPUT["flow_mode1_10_20_error"+ext1], kBlue, 26, 1.5, "p" );
   PlotData( pt3, INPUT["flow_mode2_10_20"+ext1], INPUT["flow_mode2_10_20_error"+ext1], kRed, 32, 1.5, "p" );
   ...
   //PlotData( pt3, INPUT["flowjets_mode1_10_20"+ext2], INPUT["flowjets_mode1_10_20_error"+ext2], kRed, 32, 1.5, "p" );
   ...
   PlotData( pt4, INPUT["flow_mode1_20_30"+ext1], INPUT["flow_mode1_20_30_error"+ext1], kBlue, 26, 1.5, "p" );
   PlotData( pt4, INPUT["flow_mode2_20_30"+ext1], INPUT["flow_mode2_20_30_error"+ext1], kRed, 32, 1.5, "p" );
   //PlotData( pt4, INPUT["flow_fit_20_30"+ext1], INPUT["flow_fit_20_30_error"+ext1], kCyan, 34, 1.1, "p" );

   //PlotData( pt4, INPUT["flowjets_mode1_20_30"+ext2], INPUT["flowjets_mode1_20_30_error"+ext2], kRed, 32, 1.5, "p" );
   ...
   PlotData( pt5, INPUT["flow_mode1_30_40"+ext1], INPUT["flow_mode1_30_40_error"+ext1], kBlue, 26, 1.5, "p" );
   PlotData( pt5, INPUT["flow_mode2_30_40"+ext1], INPUT["flow_mode2_30_40_error"+ext1], kRed, 32, 1.5, "p" );
   //PlotData( pt5, INPUT["flow_fit_30_40"+ext1], INPUT["flow_fit_30_40_error"+ext1], kCyan, 34, 1.1, "p" );

   //PlotData( pt5, INPUT["flowjets_mode1_30_40"+ext2], INPUT["flowjets_mode1_30_40_error"+ext2], kRed, 32, 1.5, "p" );
   ...
   PlotData( pt6, INPUT["flow_mode1_40_50"+ext1], INPUT["flow_mode1_40_50_error"+ext1], kBlue, 26, 1.5, "p" );
   PlotData( pt6, INPUT["flow_mode2_40_50"+ext1], INPUT["flow_mode2_40_50_error"+ext1], kRed, 32, 1.5, "p" );
   //PlotData( pt6, INPUT["flow_fit_40_50"+ext1], INPUT["flow_fit_40_50_error"+ext1], kCyan, 34, 1.1, "p" );

   //PlotData( pt6, INPUT["flowjets_mode1_40_50"+ext2], INPUT["flowjets_mode1_40_50_error"+ext2], kRed, 32, 1.5, "p" );
   ...
   PlotData( pt7, INPUT["flow_mode1_50_60"+ext1], INPUT["flow_mode1_50_60_error"+ext1], kBlue, 26, 1.5, "p" );
   PlotData( pt7, INPUT["flow_mode2_50_60"+ext1], INPUT["flow_mode2_50_60_error"+ext1], kRed, 32, 1.5, "p" );
   //PlotData( pt7, INPUT["flow_fit_50_60"+ext1], INPUT["flow_fit_50_60_error"+ext1], kCyan, 34, 1.1, "p" );

   //PlotData( pt7, INPUT["flowjets_mode1_50_60"+ext2], INPUT["flowjets_mode1_50_60_error"+ext2], kRed, 32, 1.5, "p" );
   ...
   std::string str((std::istreambuf_iterator<char>(t)),
                    std::istreambuf_iterator<char>());
   cc1->Print((str.substr(0, str.size()-1)+string("6/")+string(s1)+string("/")+string(deta1)+string("/cc1_3.png")).c_str());
   cc1->Print((str.substr(0, str.size()-1)+string("6/")+string(s1)+string("/")+string(deta1)+string("/cc1_3.pdf")).c_str());
}
