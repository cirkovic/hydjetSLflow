...
#config.JobType.psetName = 'testHydjet_new_pt_crab.py'
config.JobType.psetName = 'pset.py'
config.JobType.scriptExe = 'job_new_pt.sh'
...
config.JobType.inputFiles = ['subjob_new_pt.sh', 'testHydjet_new_pt_crab.py']
