...
process.load("GeneratorInterface.Hydjet2Interface.hydjet2Default_cfi_n_crab_my_min_bias_ene")
...
#       P7=cms.PSet( min=cms.double(2.5), max=cms.double(3.0)),
       P1=cms.PSet( min=cms.double(0.3), max=cms.double(0.4)),
       P2=cms.PSet( min=cms.double(0.4), max=cms.double(0.5)),
       P3=cms.PSet( min=cms.double(0.5), max=cms.double(0.625)),
       P4=cms.PSet( min=cms.double(0.625), max=cms.double(0.75)),
       P5=cms.PSet( min=cms.double(0.75), max=cms.double(0.875)),
       P6=cms.PSet( min=cms.double(0.875), max=cms.double(1)),
       P7=cms.PSet( min=cms.double(1), max=cms.double(1.25)),
       P8=cms.PSet( min=cms.double(1.25), max=cms.double(1.5)),
       P9=cms.PSet( min=cms.double(1.5), max=cms.double(1.75)),
       P10=cms.PSet( min=cms.double(1.75), max=cms.double(2)),
       P11=cms.PSet( min=cms.double(2), max=cms.double(2.25)),
       P12=cms.PSet( min=cms.double(2.25), max=cms.double(2.5)),
       P13=cms.PSet( min=cms.double(2.5), max=cms.double(2.75)),
       P14=cms.PSet( min=cms.double(2.75), max=cms.double(3)),
