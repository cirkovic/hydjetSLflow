...
#argv = ['6', '50', '2', '60-70', '2.0']
#argv = ['2000', '5000', '2', '60-70', '2.0']
argv = ['2500', '4000', '2', '60-70', '2.0']
...
#config.JobType.psetName = 'testHydjet_new_crab_502.py'
config.JobType.psetName = 'pset.py'
config.JobType.scriptExe = 'job_new_502.sh'
...
config.JobType.inputFiles = ['subjob_new_502.sh', 'testHydjet_new_crab_502.py']
