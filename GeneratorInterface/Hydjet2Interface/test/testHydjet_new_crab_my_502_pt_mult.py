...
process.load("GeneratorInterface.Hydjet2Interface.hydjet2Default_cfi_n_crab_my_502_min_bias")
...
process.ana = cms.EDAnalyzer('Hydjet2Analyzer_new_my_502_pt_mult',
    foutName = cms.untracked.string('output_'+'_'.join(argv)+'.root'),
    HepMCProductLabel = cms.string('Hydjet2Analyzer_new_my_502_pt_mult'),
