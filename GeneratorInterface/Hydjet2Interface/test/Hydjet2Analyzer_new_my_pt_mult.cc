// -*- C++ -*-
//
// Package: Hydjet2Analyzer_new_my_pt_mult
// Class: Hydjet2Analyzer_new_my_pt_mult
//
...
class Hydjet2Analyzer_new_my_pt_mult : public edm::EDAnalyzer {
public:
  explicit Hydjet2Analyzer_new_my_pt_mult(const edm::ParameterSet&);
  ~Hydjet2Analyzer_new_my_pt_mult();
private:
...
//
Hydjet2Analyzer_new_my_pt_mult::Hydjet2Analyzer_new_my_pt_mult(const edm::ParameterSet& iConfig)
{
...
Hydjet2Analyzer_new_my_pt_mult::~Hydjet2Analyzer_new_my_pt_mult()
{
...
TString Hydjet2Analyzer_new_my_pt_mult::ToString(float num){
...
int Hydjet2Analyzer_new_my_pt_mult::myrandom (int i) { return std::rand()%i;}

//
// ------------ method called to for each event ------------
void
Hydjet2Analyzer_new_my_pt_mult::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  /*
  if (MY_CODE == 2) {
      using namespace edm;
...
void
Hydjet2Analyzer_new_my_pt_mult::beginRun(const edm::Run&, const edm::EventSetup& iSetup)
{
  iSetup.getData(pdt);
}
void
Hydjet2Analyzer_new_my_pt_mult::beginJob()
{
  if(printLists_){
...
void Hydjet2Analyzer_new_my_pt_mult:: DO_BACKGROUND2(EVENT* EVENTS, vector<pair<int, int>> PAIRS, string Noff){
...
void Hydjet2Analyzer_new_my_pt_mult:: CORRELATION_OF_MIXED_EVENTS(map<string, vector<TRIPLET>> PT_FIXED, map<string, vector<TRIPLET>> PT_CURRENT, string Noff_name){
...
void
Hydjet2Analyzer_new_my_pt_mult::endJob() {
}
//define this as a plug-in
DEFINE_FWK_MODULE(Hydjet2Analyzer_new_my_pt_mult);
