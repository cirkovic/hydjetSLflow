...
#config.JobType.psetName = 'testHydjet_new_crab_my_276_pt_mult.py'
config.JobType.psetName = 'pset.py'
config.JobType.scriptExe = 'job_new_my_276_pt_mult.sh'
...
config.JobType.inputFiles = ['subjob_new_my_276_pt_mult.sh', 'testHydjet_new_crab_my_276_pt_mult.py']
