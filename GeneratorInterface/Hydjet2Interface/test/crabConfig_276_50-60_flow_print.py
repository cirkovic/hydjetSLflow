...
argv = ['10', '320', '0', '50-60', '2.0', '276']

config.section_("General")
print config.General.workArea

config.section_("JobType")
print config.JobType.pluginName

print config.JobType.scriptArgs

print config.JobType.inputFiles
print config.JobType.disableAutomaticOutputCollection

print config.JobType.outputFiles
print config.JobType.sendPythonFolder
print config.JobType.numCores
print config.JobType.maxMemoryMB

config.section_("Data")
print config.Data.publication
print config.Data.splitting
print config.Data.totalUnits
print config.Data.unitsPerJob
print config.Data.ignoreLocality

config.section_("Site")

print config.Site.storageSite
...
#config.Site.storageSite = 'T3_IT_Perugia'
