// -*- C++ -*-
//
// Package: Hydjet2Analyzer_new_502
// Class: Hydjet2Analyzer_new_502
//
...
class Hydjet2Analyzer_new_502 : public edm::EDAnalyzer {
public:
  explicit Hydjet2Analyzer_new_502(const edm::ParameterSet&);
  ~Hydjet2Analyzer_new_502();
private:
  ...
  TH1F *hevt, *hmult1L, *hmult2L, *hsum_cosL, *hsum_cos_normL;
  TH2F *hdelta_eta_phi;
  TH2F *hfractionS, *hfractionB, *heventcountS, *heventcountB;
  TH1F **Hmult1L, **Hmult2L, **Hsum_cosL, **Hsum_cos_normL;
...
//
Hydjet2Analyzer_new_502::Hydjet2Analyzer_new_502(const edm::ParameterSet& iConfig)
{
...
Hydjet2Analyzer_new_502::~Hydjet2Analyzer_new_502()
{
...
TString Hydjet2Analyzer_new_502::ToString(float num){
...
int Hydjet2Analyzer_new_502::myrandom (int i) { return std::rand()%i;}

//
// ------------ method called to for each event ------------
void
Hydjet2Analyzer_new_502::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  /*
  if (MY_CODE == 2) {
      using namespace edm;
...
void
Hydjet2Analyzer_new_502::beginRun(const edm::Run&, const edm::EventSetup& iSetup)
{
  iSetup.getData(pdt);
}
void
Hydjet2Analyzer_new_502::beginJob()
{
  if(printLists_){
...
void Hydjet2Analyzer_new_502:: DO_BACKGROUND2(EVENT* EVENTS, vector<pair<int, int>> PAIRS, string Noff){
...
void Hydjet2Analyzer_new_502:: CORRELATION_OF_MIXED_EVENTS(map<string, vector<TRIPLET>> PT_FIXED, map<string, vector<TRIPLET>> PT_CURRENT, string Noff_name){
...
void
Hydjet2Analyzer_new_502::endJob() {
}
//define this as a plug-in
DEFINE_FWK_MODULE(Hydjet2Analyzer_new_502);
