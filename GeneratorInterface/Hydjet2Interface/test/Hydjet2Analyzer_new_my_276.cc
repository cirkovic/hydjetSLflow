// -*- C++ -*-
//
// Package: Hydjet2Analyzer_new_my_276
// Class: Hydjet2Analyzer_new_my_276
//
...
class Hydjet2Analyzer_new_my_276 : public edm::EDAnalyzer {
public:
  explicit Hydjet2Analyzer_new_my_276(const edm::ParameterSet&);
  ~Hydjet2Analyzer_new_my_276();
private:
...
//
Hydjet2Analyzer_new_my_276::Hydjet2Analyzer_new_my_276(const edm::ParameterSet& iConfig)
{
...
Hydjet2Analyzer_new_my_276::~Hydjet2Analyzer_new_my_276()
{
...
TString Hydjet2Analyzer_new_my_276::ToString(float num){
...
int Hydjet2Analyzer_new_my_276::myrandom (int i) { return std::rand()%i;}

//
// ------------ method called to for each event ------------
void
Hydjet2Analyzer_new_my_276::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  /*
  if (MY_CODE == 2) {
      using namespace edm;
...
void
Hydjet2Analyzer_new_my_276::beginRun(const edm::Run&, const edm::EventSetup& iSetup)
{
  iSetup.getData(pdt);
}
void
Hydjet2Analyzer_new_my_276::beginJob()
{
  if(printLists_){
...
void Hydjet2Analyzer_new_my_276:: DO_BACKGROUND2(EVENT* EVENTS, vector<pair<int, int>> PAIRS, string Noff){
...
void Hydjet2Analyzer_new_my_276:: CORRELATION_OF_MIXED_EVENTS(map<string, vector<TRIPLET>> PT_FIXED, map<string, vector<TRIPLET>> PT_CURRENT, string Noff_name){
...
void
Hydjet2Analyzer_new_my_276::endJob() {
}
//define this as a plug-in
DEFINE_FWK_MODULE(Hydjet2Analyzer_new_my_276);
