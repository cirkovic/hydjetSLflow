...
process.load("GeneratorInterface.Hydjet2Interface.hydjet2Default_cfi_n_crab_my_276_min_bias")
...
process.ana = cms.EDAnalyzer('Hydjet2Analyzer_new_my_276_pt_mult',
    foutName = cms.untracked.string('output_'+'_'.join(argv)+'.root'),
    HepMCProductLabel = cms.string('Hydjet2Analyzer_new_my_276_pt_mult'),
       ...
       P1=cms.PSet( min=cms.double(0.25), max=cms.double(0.5)),
