...
argv = ['5000', '1000', '2', '50-60', '2.0', '276']
...
config.JobType.scriptExe = 'job_new_my_pt_mult_ene_14.sh'
...
config.JobType.inputFiles = ['subjob_new_my_pt_mult_ene_14.sh', 'testHydjet_new_crab_my_pt_mult_ene_14.py']
