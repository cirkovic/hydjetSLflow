...
process.load("GeneratorInterface.Hydjet2Interface.hydjet2Default_cfi_n_crab_my_502")
...
process.ana = cms.EDAnalyzer('Hydjet2Analyzer_new_my_502_pt',
    foutName = cms.untracked.string('output_'+'_'.join(argv)+'.root'),
    HepMCProductLabel = cms.string('Hydjet2Analyzer_new_my_502_pt'),
