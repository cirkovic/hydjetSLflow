...
#outdir = '/afs/cern.ch/user/c/cirkovic/www/29-05-2016/hydjet/2'
outdir = '/afs/cern.ch/user/c/cirkovic/www/30-05-2016/hydjet/2'

def loop(case, ci, c):

    #fs.append(TFile.Open('output_'+str(N)+'_'+str(case)+'_'+c+'_'+str(deltaEtaCut)+'.root'))
    fs.append(TFile.Open('OUTPUT/merged/output_all_'+str(case)+'_'+c+'_'+str(deltaEtaCut)+'.root'))
