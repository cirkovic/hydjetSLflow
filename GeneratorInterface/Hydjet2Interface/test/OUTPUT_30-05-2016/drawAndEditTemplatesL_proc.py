...
call("cp -f ./TEMPLATES/out_0_*.root .", shell=True)
...
#OPATH = '/afs/cern.ch/user/c/cirkovic/www/29-05-2016/hydjet/1/'
OPATH = '/afs/cern.ch/user/c/cirkovic/www/30-05-2016/hydjet/1/'
...
def loop(case, ci, cent):
    ...
    ftmp = TFile.Open('OUTPUT/merged/output_all_'+str(case)+'_'+str(cent)+'_'+str(deltaEtaCut)+'.root')
