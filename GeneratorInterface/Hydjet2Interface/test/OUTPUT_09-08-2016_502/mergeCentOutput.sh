...
do
    ...
    hadd -k -f output_all_${s}_${c[$i]}_${deltaEtaCut}.root `ls /tmp/cirkovic/${first[$i]}/results/output_${Nevt}_${s}_${c[$i]}_${deltaEtaCut}_*.root` output_10M/output_*_${s}_${c[$i]}_${deltaEtaCut}.root &
done
