...
#config.JobType.psetName = 'testHydjet_new_crab_my_276.py'
config.JobType.psetName = 'pset.py'
config.JobType.scriptExe = 'job_new_my_276.sh'
...
config.JobType.inputFiles = ['subjob_new_my_276.sh', 'testHydjet_new_crab_my_276.py']
