...
#config.JobType.psetName = 'testHydjet_new_crab_my_pt_mult_276_2.py'
config.JobType.psetName = 'pset.py'
config.JobType.scriptExe = 'job_new_my_pt_mult_276_2.sh'
...
config.JobType.inputFiles = ['subjob_new_my_pt_mult_276_2.sh', 'testHydjet_new_crab_my_pt_mult_276_2.py']
