...
def main():
       ...
       for i in range(0,DIM):
           ...
           #fns[-1].SetParameter(0, pars["5.02TeV_"+cent+"_"+nx+"_gfs_"+str(i)+"_mode_2"][0][3][0])
           fns[-1].SetParameter(0, 1.0)
           fns[-1].SetParameter(1, pars["5.02TeV_"+cent+"_"+nx+"_gfs_"+str(i)+"_mode_2"][0][gi][1])
           fns[-1].SetParameter(2, pars["5.02TeV_"+cent+"_"+nx+"_gfs_"+str(i)+"_mode_2"][0][gi][2])
           #fns[-1].Print()
...
#           eigenvectors=dict()
       ...
       if OLD:
           ...
           #print "JSON MEAN:", pars["5.02TeV_00_02_n2_gfs_4_mode_2"][0][0][0]
           if GENMEAN:
               simulated_eigenvalues["2"]=pars["5.02TeV_"+cent+"_"+nx+"_gfs_"+str(2)+"_mode_2"][0][3][1]
           else:
               simulated_eigenvalues["2"]=pars["5.02TeV_"+cent+"_"+nx+"_gfs_"+str(2)+"_mode_2"][0][0][1]
       ...
       if OLD:
          ...
          #print "JSON ERROR:", pars["5.02TeV_00_02_n2_gfs_4_mode_2"][0][0][1]
          if GENMEAN:
              simulated_eigenvalues_errors["2"]=pars["5.02TeV_"+cent+"_"+nx+"_gfs_"+str(2)+"_mode_2"][0][3][2]
          else:
              simulated_eigenvalues_errors["2"]=pars["5.02TeV_"+cent+"_"+nx+"_gfs_"+str(2)+"_mode_2"][0][0][2]
