...
def GET_MATRIX(SIGNAL, subfolder):
   ...
   for bin in BINS:
          ...
          with open(subfolder+"/fracS.txt", 'a') as f:
...
def main():
   ...
   #MATRIX_n2 =GET_MATRIX(COS_n2, "./"+ centrality)#, COS_n2_BACK)
   #MATRIX_n3 =GET_MATRIX(COS_n3, "./"+ centrality)#, COS_n3_BACK)

   MATRIX_n2 =GET_MATRIX(COS_n2, "./"+SUB_folder_n2)#, COS_n2_BACK)
   MATRIX_n3 =GET_MATRIX(COS_n3, "./"+SUB_folder_n3)#, COS_n3_BACK)
