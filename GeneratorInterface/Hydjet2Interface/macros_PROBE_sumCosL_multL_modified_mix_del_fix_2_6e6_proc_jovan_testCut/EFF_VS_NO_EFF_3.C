...
void EFF_VS_NO_EFF_3(const char *s, const char *deta){
   ...
   */
   ...
   ////////////////////////////////////////////////
   //
   //cc1->Print("~/www/09-05-2016/hydjet/4/2/cc1_3.png");
   //cc1->Print("~/www/10-05-2016/hydjet/4/2/cc1_3.png");
   //cc1->Print("~/www/13-05-2016/hydjet/4/2/cc1_3.png");
   cc1->Print((string("~/www/14-05-2016/hydjet/4/")+string(s)+string("/")+string(deta)+string("/cc1_3.png")).c_str());
}
