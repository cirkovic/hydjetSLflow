...
void EFF_VS_NO_EFF_1(const char *s, const char *deta){
   ...
   /*
   // UCC
   document=READFILE((string("./DATA/")+string(deta)+string("/n2/00_02.json")).c_str());
   ...
   document=READFILE((string("./DATA/")+string(deta)+string("/n3/00_02.json")).c_str());
   ...
   // 0-5
   document=READFILE((string("./DATA/")+string(deta)+string("/n2/00_05.json")).c_str());
   ...
   document=READFILE((string("./DATA/")+string(deta)+string("/n3/00_05.json")).c_str());
   ...
   // 0-10
   document=READFILE((string("./DATA/")+string(deta)+string("/n2/00_10.json")).c_str());
   ...
   document=READFILE((string("./DATA/")+string(deta)+string("/n3/00_10.json")).c_str());
   ...
   // 10-20
   document=READFILE((string("./DATA/")+string(deta)+string("/n2/10_20.json")).c_str());
   ...
   document=READFILE((string("./DATA/")+string(deta)+string("/n3/10_20.json")).c_str());
   ...
   // 20-30
   document=READFILE((string("./DATA/")+string(deta)+string("/n2/20_30.json")).c_str());
   ...
   // 20-30 Z CUT
   document=READFILE((string("./DATA/")+string(deta)+string("/n3/20_30.json")).c_str());
   ...
   // 30-40
   document=READFILE((string("./DATA/")+string(deta)+string("/n2/30_40.json")).c_str());
   ...
   document=READFILE((string("./DATA/")+string(deta)+string("/n3/30_40.json")).c_str());
   ...
   // 40-50
   document=READFILE((string("./DATA/")+string(deta)+string("/n2/40_50.json")).c_str());
   ...
   document=READFILE((string("./DATA/")+string(deta)+string("/n3/40_50.json")).c_str());
