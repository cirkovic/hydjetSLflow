...
void EFF_VS_NO_EFF_2(const char *s, const char *deta){
   ...
   /*
   // UCC
   document=READFILE("./DATA/n2/00_02.json");
   ...
   document=READFILE("./DATA/n3/00_02.json");
   ...
   // 0-5
   document=READFILE("./DATA/n2/00_05.json");
   ...
   document=READFILE("./DATA/n3/00_05.json");
   ...
   // 0-10
   document=READFILE("./DATA/n2/00_10.json");
   ...
   document=READFILE("./DATA/n3/00_10.json");
   ...
   // 10-20
   document=READFILE("./DATA/n2/10_20.json");
   ...
   document=READFILE("./DATA/n3/10_20.json");
   ...
   // 20-30
   document=READFILE("./DATA/n2/20_30.json");
   ...
   // 20-30 Z CUT
   document=READFILE("./DATA/n3/20_30.json");
   ...
   // 30-40
   document=READFILE("./DATA/n2/30_40.json");
   ...
   document=READFILE("./DATA/n3/30_40.json");
   ...
   // 40-50
   document=READFILE("./DATA/n2/40_50.json");
   ...
   document=READFILE("./DATA/n3/40_50.json");
   ...
   */
   ...
   ////////////////////////////////////////////////
   //
   //cc1->Print("~/www/09-05-2016/hydjet/4/2/cc1_2.png");
   //cc1->Print("~/www/10-05-2016/hydjet/4/2/cc1_2.png");
   //cc1->Print("~/www/13-05-2016/hydjet/4/2/cc1_2.png");
   cc1->Print((string("~/www/14-05-2016/hydjet/4/")+string(s)+string("/")+string(deta)+string("/cc1_2.png")).c_str());
}
