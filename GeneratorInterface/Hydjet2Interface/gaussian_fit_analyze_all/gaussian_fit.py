    ...
    for centrality in ['00_02', '00_05', '00_10', '10_20', '20_30', '30_40', '40_50', '50_60']:
        for n in ['n2', 'n3']:
            for mode in ['mode_2']:
                ...
                fs.append(TFile.Open("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_40M_16-09-2016_"+label+"_analyze_0/2/2.0/"+centrality+"/"+centrality+"/data_"+n+"/pca_data.root"))
                fs0.append(TFile.Open("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_40M_16-09-2016_"+label+"/2/2.0/"+centrality+"/"+centrality+"/data_"+n+"/pca_data.root"))
                '''
                fs[-1].ls()
                for i in xrange(0, 7):
