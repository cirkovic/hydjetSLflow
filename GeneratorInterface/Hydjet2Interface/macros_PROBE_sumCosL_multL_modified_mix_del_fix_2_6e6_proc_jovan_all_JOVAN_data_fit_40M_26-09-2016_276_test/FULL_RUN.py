...
#                 call(['python', '../../make_matrix_split.py', x, FOLDER, str(DIM)])
    ...
    for x in cent:
          ...
          print "CALCULATING MATRIX.........n23\n\n"
          if SPLIT==False: call(['python', '../../make_matrix_np.py', x, FOLDER, str(DIM)])
#          if SPLIT==True:
#                 call(['python', '../../make_matrix_normed_split.py', x, FOLDER, str(DIM)])
#                 call(['python', '../../make_matrix_split.py', x, FOLDER, str(DIM)])
    ...
    for x in cent:
          ...
          call(['python', '../../run_matrix.py', working_folder+"/data_n2", str(iter), argv[1]])

          print "MATRIX PERMUTATION.....n3\n\n "
          call(['python', '../../run_matrix.py', working_folder+"/data_n3", str(iter), argv[1]])
    ...
    for x in cent:
          ...
          print "MATRIX PERMUTATION.....n2\n\n "
          call(['python', '../../run_matrix_np.py', working_folder+"/data_n2_np", str(iter), argv[1]])

          print "MATRIX PERMUTATION.....n3\n\n "
          call(['python', '../../run_matrix_np.py', working_folder+"/data_n3_np", str(iter), argv[1]])
