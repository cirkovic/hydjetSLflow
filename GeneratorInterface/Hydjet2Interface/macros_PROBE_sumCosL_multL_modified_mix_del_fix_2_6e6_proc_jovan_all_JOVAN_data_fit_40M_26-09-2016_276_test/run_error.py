...
def main():
          ...
          f1=open(working_folder+"/simulated_eigenvalues_7x7.json", "r")  # 1-10 format
          f2=open(working_folder+ "/simulated_eigenvectors_7x7.json", "r")  # 1-10 format

          f3=open(working_folder+"/eigenvector_errors_7x7.json", "r")  # 1-10 format
          f4=open(working_folder+"/eigenvalue_errors_7x7.json", "r")  # 1-10 format
...
#                 f_mode1_root.write(str(mode1_errors["P"+str(ei)])), f_mode1_root.write(",")
                 f_mode1_root.write(str(0.0)), f_mode1_root.write(",")
#                 f_mode2_root.write(str(mode2_errors["P"+str(ei)])), f_mode2_root.write(",")
                 f_mode2_root.write(str(0.0)), f_mode2_root.write(",")
...
#                 f_mode1.write(str(mode1_errors["P"+str(ei)])), f_mode1.write("\n")
                 f_mode1.write(str(0.0)), f_mode1.write("\n")
#                 f_mode2.write(str(mode2_errors["P"+str(ei)])), f_mode2.write("\n")
                 f_mode2.write(str(0.0)), f_mode2.write("\n")
