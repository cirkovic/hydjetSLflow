...
void EFF_VS_NO_EFF_5(const char *s, const char *deta){
   ...
   */
   ...
   document=READFILE((string("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_12-07-2016/FIT/")+string(s)+string("/")+string(deta)+string("/n3/00_02.json")).c_str());
   ...
   document=READFILE((string("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_12-07-2016/FIT/")+string(s)+string("/")+string(deta)+string("/n3/00_05.json")).c_str());
   ...
   document=READFILE((string("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_12-07-2016/FIT/")+string(s)+string("/")+string(deta)+string("/n3/00_10.json")).c_str());
   ...
   document=READFILE((string("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_12-07-2016/FIT/")+string(s)+string("/")+string(deta)+string("/n3/10_20.json")).c_str());
   ...
   document=READFILE((string("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_12-07-2016/FIT/")+string(s)+string("/")+string(deta)+string("/n3/20_30.json")).c_str());
   ...
   document=READFILE((string("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_12-07-2016/FIT/")+string(s)+string("/")+string(deta)+string("/n3/30_40.json")).c_str());
   ...
   document=READFILE((string("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_12-07-2016/FIT/")+string(s)+string("/")+string(deta)+string("/n3/40_50.json")).c_str());
   ...
   document=READFILE((string("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_12-07-2016/FIT/")+string(s)+string("/")+string(deta)+string("/n3/50_60.json")).c_str());
   ...
   PlotData( pt0, INPUT["mode1_UCC"+ext2], INPUT["mode1_UCC_error"+ext2], kBlue-1, 21, 1.1, "p" );
   PlotData( pt0, INPUT["mode2_UCC"+ext2], INPUT["mode2_UCC_error"+ext2], kRed-1, 21, 1.1, "p" );
   PlotData( pt0, INPUT["fit_UCC"+ext1], INPUT["fit_UCC_error"+ext1], kGreen-1, 34, 1.1, "p" );
   ...
   PlotData( pt1, INPUT["mode1_00_05"+ext2], INPUT["mode1_00_05_error"+ext2], kBlue-1, 21, 1.1, "p" );
   PlotData( pt1, INPUT["mode2_00_05"+ext2], INPUT["mode2_00_05_error"+ext2], kRed-1, 21, 1.1, "p" );
   PlotData( pt1, INPUT["fit_00_05"+ext1], INPUT["fit_00_05_error"+ext1], kGreen-1, 34, 1.1, "p" );
   ...
   PlotData( pt2, INPUT["mode1_00_10"+ext2], INPUT["mode1_00_10_error"+ext2], kBlue-1, 21, 1.1, "p" );
   PlotData( pt2, INPUT["mode2_00_10"+ext2], INPUT["mode2_00_10_error"+ext2], kRed-1, 21, 1.1, "p" );
   PlotData( pt2, INPUT["fit_00_10"+ext1], INPUT["fit_00_10_error"+ext1], kGreen-1, 34, 1.1, "p" );
   ...
   PlotData( pt3, INPUT["mode1_10_20"+ext2], INPUT["mode1_10_20_error"+ext2], kBlue-1, 21, 1.1, "p" );
   PlotData( pt3, INPUT["mode2_10_20"+ext2], INPUT["mode2_10_20_error"+ext2], kRed-1, 21, 1.1, "p" );
   PlotData( pt3, INPUT["fit_10_20"+ext1], INPUT["fit_10_20_error"+ext1], kGreen-1, 34, 1.1, "p" );
   ...
   PlotData( pt4, INPUT["mode1_20_30"+ext2], INPUT["mode1_20_30_error"+ext2], kBlue-1, 21, 1.1, "p" );
   PlotData( pt4, INPUT["mode2_20_30"+ext2], INPUT["mode2_20_30_error"+ext2], kRed-1, 21, 1.1, "p" );
   PlotData( pt4, INPUT["fit_20_30"+ext1], INPUT["fit_20_30_error"+ext1], kGreen-1, 34, 1.1, "p" );
   ...
   PlotData( pt5, INPUT["mode1_30_40"+ext2], INPUT["mode1_30_40_error"+ext2], kBlue-1, 21, 1.1, "p" );
   PlotData( pt5, INPUT["mode2_30_40"+ext2], INPUT["mode2_30_40_error"+ext2], kRed-1, 21, 1.1, "p" );
   PlotData( pt5, INPUT["fit_30_40"+ext1], INPUT["fit_30_40_error"+ext1], kGreen-1, 34, 1.1, "p" );
   ...
   PlotData( pt6, INPUT["mode1_40_50"+ext2], INPUT["mode1_40_50_error"+ext2], kBlue-1, 21, 1.1, "p" );
   PlotData( pt6, INPUT["mode2_40_50"+ext2], INPUT["mode2_40_50_error"+ext2], kRed-1, 21, 1.1, "p" );
   PlotData( pt6, INPUT["fit_40_50"+ext1], INPUT["fit_40_50_error"+ext1], kGreen-1, 34, 1.1, "p" );
   ...
   PlotData( pt7, INPUT["mode1_50_60"+ext2], INPUT["mode1_50_60_error"+ext2], kBlue-1, 21, 1.1, "p" );
   PlotData( pt7, INPUT["mode2_50_60"+ext2], INPUT["mode2_50_60_error"+ext2], kRed-1, 21, 1.1, "p" );
   PlotData( pt7, INPUT["fit_50_60"+ext1], INPUT["fit_50_60_error"+ext1], kGreen-1, 34, 1.1, "p" );
   ...
   std::string str((std::istreambuf_iterator<char>(t)),
                    std::istreambuf_iterator<char>());
   cc1->Print((str.substr(0, str.size()-1)+string("4/")+string(s)+string("/")+string(deta)+string("/cc1_5.png")).c_str());
   cc1->Print((str.substr(0, str.size()-1)+string("4/")+string(s)+string("/")+string(deta)+string("/cc1_5.pdf")).c_str());
}
