...
void DoLegend(){
   ...
   */
   ...
   entry=leg->AddEntry("", "#alpha=1, 2.76TeV","p");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(4);
   ...
   entry=leg->AddEntry("", "#alpha=1, 5.02TeV","p");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(4);
   ...
   entry=leg->AddEntry("", "#alpha=2, 2.76TeV","p");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(4);
   ...
   entry=leg->AddEntry("", "#alpha=2, 5.02TeV","p");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(4);
   ...
   entry=leg->AddEntry("", "fit, 2.76TeV","p");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(4);
   ...
   entry=leg->AddEntry("", "fit, 5.02TeV","p");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(4);
   entry->SetMarkerColor(kOrange);
...
void PlotData(double* pt, double* data, double* data_error, Color_t color, int MarkerStyle, double MarkerSize, TString point, int LineWidth = 2){
...
void EFF_VS_NO_EFF_4(const char *s, const char *deta){
   ...
   */
   ...
   // UCC
   document=READFILE((string("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_12-07-2016/DATA/")+string(s)+string("/")+string(deta)+string("/n2/00_02.json")).c_str());
   ...
   document=READFILE((string("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_12-07-2016/FIT/")+string(s)+string("/")+string(deta)+string("/n2/00_02.json")).c_str());
   INPUT["fit_UCC"+ext1]=ReadData(document, "mode1");
   INPUT["fit_UCC_error"+ext1]=ReadData(document, "mode1_error");

   document=READFILE((string("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_12-07-2016/DATA/")+string(s)+string("/")+string(deta)+string("/n3/00_02.json")).c_str());
   ...
   // 0-5
   document=READFILE((string("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_12-07-2016/DATA/")+string(s)+string("/")+string(deta)+string("/n2/00_05.json")).c_str());
   ...
   document=READFILE((string("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_12-07-2016/FIT/")+string(s)+string("/")+string(deta)+string("/n2/00_05.json")).c_str());
   INPUT["fit_00_05"+ext1]=ReadData(document, "mode1");
   INPUT["fit_00_05_error"+ext1]=ReadData(document, "mode1_error");

   document=READFILE((string("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_12-07-2016/DATA/")+string(s)+string("/")+string(deta)+string("/n3/00_05.json")).c_str());
   ...
   // 0-10
   document=READFILE((string("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_12-07-2016/DATA/")+string(s)+string("/")+string(deta)+string("/n2/00_10.json")).c_str());
   ...
   document=READFILE((string("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_12-07-2016/FIT/")+string(s)+string("/")+string(deta)+string("/n2/00_10.json")).c_str());
   INPUT["fit_00_10"+ext1]=ReadData(document, "mode1");
   INPUT["fit_00_10_error"+ext1]=ReadData(document, "mode1_error");

   document=READFILE((string("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_12-07-2016/DATA/")+string(s)+string("/")+string(deta)+string("/n3/00_10.json")).c_str());
   ...
   // 10-20
   document=READFILE((string("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_12-07-2016/DATA/")+string(s)+string("/")+string(deta)+string("/n2/10_20.json")).c_str());
   ...
   document=READFILE((string("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_12-07-2016/FIT/")+string(s)+string("/")+string(deta)+string("/n2/10_20.json")).c_str());
   INPUT["fit_10_20"+ext1]=ReadData(document, "mode1");
   INPUT["fit_10_20_error"+ext1]=ReadData(document, "mode1_error");

   document=READFILE((string("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_12-07-2016/DATA/")+string(s)+string("/")+string(deta)+string("/n3/10_20.json")).c_str());
   ...
   // 20-30
   document=READFILE((string("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_12-07-2016/DATA/")+string(s)+string("/")+string(deta)+string("/n2/20_30.json")).c_str());
   ...
   document=READFILE((string("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_12-07-2016/FIT/")+string(s)+string("/")+string(deta)+string("/n2/20_30.json")).c_str());
   INPUT["fit_20_30"+ext1]=ReadData(document, "mode1");
   INPUT["fit_20_30_error"+ext1]=ReadData(document, "mode1_error");

   // 20-30 Z CUT
   document=READFILE((string("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_12-07-2016/DATA/")+string(s)+string("/")+string(deta)+string("/n3/20_30.json")).c_str());
   ...
   // 30-40
   document=READFILE((string("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_12-07-2016/DATA/")+string(s)+string("/")+string(deta)+string("/n2/30_40.json")).c_str());
   ...
   document=READFILE((string("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_12-07-2016/FIT/")+string(s)+string("/")+string(deta)+string("/n2/30_40.json")).c_str());
   INPUT["fit_30_40"+ext1]=ReadData(document, "mode1");
   INPUT["fit_30_40_error"+ext1]=ReadData(document, "mode1_error");

   document=READFILE((string("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_12-07-2016/DATA/")+string(s)+string("/")+string(deta)+string("/n3/30_40.json")).c_str());
   ...
   // 40-50
   document=READFILE((string("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_12-07-2016/DATA/")+string(s)+string("/")+string(deta)+string("/n2/40_50.json")).c_str());
   ...
   document=READFILE((string("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_12-07-2016/FIT/")+string(s)+string("/")+string(deta)+string("/n2/40_50.json")).c_str());
   INPUT["fit_40_50"+ext1]=ReadData(document, "mode1");
   INPUT["fit_40_50_error"+ext1]=ReadData(document, "mode1_error");

   document=READFILE((string("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_12-07-2016/DATA/")+string(s)+string("/")+string(deta)+string("/n3/40_50.json")).c_str());
   ...
   // 50-60
   document=READFILE((string("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_12-07-2016/DATA/")+string(s)+string("/")+string(deta)+string("/n2/50_60.json")).c_str());
   ...
   document=READFILE((string("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_12-07-2016/FIT/")+string(s)+string("/")+string(deta)+string("/n2/50_60.json")).c_str());
   INPUT["fit_50_60"+ext1]=ReadData(document, "mode1");
   INPUT["fit_50_60_error"+ext1]=ReadData(document, "mode1_error");

   document=READFILE((string("../macros_PROBE_sumCosL_multL_modified_mix_del_fix_2_6e6_proc_jovan_all_JOVAN_data_fit_12-07-2016/DATA/")+string(s)+string("/")+string(deta)+string("/n3/50_60.json")).c_str());
   ...
   PlotData( pt0, INPUT["mode1_UCC"+ext1], INPUT["mode1_UCC_error"+ext1], kBlue, 21, 1.1, "pl", 1 );
   PlotData( pt0, INPUT["mode2_UCC"+ext1], INPUT["mode2_UCC_error"+ext1], kRed, 21, 1.1, "pl", 1 );
   PlotData( pt0, INPUT["fit_UCC"+ext1], INPUT["fit_UCC_error"+ext1], kGreen, 34, 1.1, "pl", 1 );

   //PlotData( pt0, INPUT["mode1_UCC"+ext2], INPUT["mode1_UCC_error"+ext2], kRed, 25, 1.1, "pl", 1 );
   //PlotData( pt0, INPUT["mode2_UCC"+ext2], INPUT["mode2_UCC_error"+ext2], kBlack, 25, 1.1, "pl", 1 );

   PlotData( pt0, INPUT["mode1_UCC"+ext3], INPUT["mode1_UCC_error"+ext3], kViolet, 21, 1.1, "pl", 1 );
   PlotData( pt0, INPUT["mode2_UCC"+ext3], INPUT["mode2_UCC_error"+ext3], kMagenta, 21, 1.1, "pl", 1 );
   PlotData( pt0, INPUT["fit_UCC"+ext3], INPUT["fit_UCC_error"+ext3], kOrange, 34, 1.1, "pl", 1 );

   //PlotData( pt0, INPUT["mode1_UCC"+ext4], INPUT["mode1_UCC_error"+ext4], kRed, 25, 1.1, "pl", 1 );
   //PlotData( pt0, INPUT["mode2_UCC"+ext4], INPUT["mode2_UCC_error"+ext4], kBlack, 25, 1.1, "pl", 1 );

   //PlotData( x20_arr, y20_arr, y20_err, kOrange, 24, 1.1, "pl", 1 );
   ...
   PlotData( pt1, INPUT["mode1_00_05"+ext1], INPUT["mode1_00_05_error"+ext1], kBlue, 21, 1.1, "pl", 1 );
   PlotData( pt1, INPUT["mode2_00_05"+ext1], INPUT["mode2_00_05_error"+ext1], kRed, 21, 1.1, "pl", 1 );
   PlotData( pt1, INPUT["fit_00_05"+ext1], INPUT["fit_00_05_error"+ext1], kGreen, 34, 1.1, "pl", 1 );

   //PlotData( pt1, INPUT["mode1_00_05"+ext2], INPUT["mode1_00_05_error"+ext2], kRed, 25, 1.1, "pl", 1 );
   //PlotData( pt1, INPUT["mode2_00_05"+ext2], INPUT["mode2_00_05_error"+ext2], kBlack, 25, 1.1, "pl", 1 );

   PlotData( pt1, INPUT["mode1_00_05"+ext3], INPUT["mode1_00_05_error"+ext3], kViolet, 21, 1.1, "pl", 1 );
   PlotData( pt1, INPUT["mode2_00_05"+ext3], INPUT["mode2_00_05_error"+ext3], kMagenta, 21, 1.1, "pl", 1 );
   PlotData( pt1, INPUT["fit_00_05"+ext3], INPUT["fit_00_05_error"+ext3], kOrange, 34, 1.1, "pl", 1 );

   //PlotData( pt1, INPUT["mode1_00_05"+ext4], INPUT["mode1_00_05_error"+ext4], kRed, 25, 1.1, "pl", 1 );
   //PlotData( pt1, INPUT["mode2_00_05"+ext4], INPUT["mode2_00_05_error"+ext4], kBlack, 25, 1.1, "pl", 1 );
   ...
   PlotData( pt2, INPUT["mode1_00_10"+ext1], INPUT["mode1_00_10_error"+ext1], kBlue, 21, 1.1, "pl", 1 );
   PlotData( pt2, INPUT["mode2_00_10"+ext1], INPUT["mode2_00_10_error"+ext1], kRed, 21, 1.1, "pl", 1 );
   PlotData( pt2, INPUT["fit_00_10"+ext1], INPUT["fit_00_10_error"+ext1], kGreen, 34, 1.1, "pl", 1 );

   //PlotData( pt2, INPUT["mode1_00_10"+ext2], INPUT["mode1_00_10_error"+ext2], kRed, 25, 1.1, "pl", 1 );
   //PlotData( pt2, INPUT["mode2_00_10"+ext2], INPUT["mode2_00_10_error"+ext2], kBlack, 25, 1.1, "pl", 1 );

   PlotData( pt2, INPUT["mode1_00_10"+ext3], INPUT["mode1_00_10_error"+ext3], kViolet, 21, 1.1, "pl", 1 );
   PlotData( pt2, INPUT["mode2_00_10"+ext3], INPUT["mode2_00_10_error"+ext3], kMagenta, 21, 1.1, "pl", 1 );
   PlotData( pt2, INPUT["fit_00_10"+ext3], INPUT["fit_00_10_error"+ext3], kOrange, 34, 1.1, "pl", 1 );

   //PlotData( pt2, INPUT["mode1_00_10"+ext4], INPUT["mode1_00_10_error"+ext4], kRed, 25, 1.1, "pl", 1 );
   //PlotData( pt2, INPUT["mode2_00_10"+ext4], INPUT["mode2_00_10_error"+ext4], kBlack, 25, 1.1, "pl", 1 );
   ...
   PlotData( pt3, INPUT["mode1_10_20"+ext1], INPUT["mode1_10_20_error"+ext1], kBlue, 21, 1.1, "pl", 1 );
   PlotData( pt3, INPUT["mode2_10_20"+ext1], INPUT["mode2_10_20_error"+ext1], kRed, 21, 1.1, "pl", 1 );
   PlotData( pt3, INPUT["fit_10_20"+ext1], INPUT["fit_10_20_error"+ext1], kGreen, 34, 1.1, "pl", 1 );
   DoLatex(0.1, 0.81, "#scale[1.3]{PbPb  #sqrt{s_{NN}} = 2.76 vs. 5.02 TeV}");//position, text

   //PlotData( pt3, INPUT["mode1_10_20"+ext2], INPUT["mode1_10_20_error"+ext2], kRed, 25, 1.1, "pl", 1 );
   //PlotData( pt3, INPUT["mode2_10_20"+ext2], INPUT["mode2_10_20_error"+ext2], kBlack, 25, 1.1, "pl", 1 );

   PlotData( pt3, INPUT["mode1_10_20"+ext3], INPUT["mode1_10_20_error"+ext3], kViolet, 21, 1.1, "pl", 1 );
   PlotData( pt3, INPUT["mode2_10_20"+ext3], INPUT["mode2_10_20_error"+ext3], kMagenta, 21, 1.1, "pl", 1 );
   PlotData( pt3, INPUT["fit_10_20"+ext3], INPUT["fit_10_20_error"+ext3], kOrange, 34, 1.1, "pl", 1 );

   //PlotData( pt3, INPUT["mode1_10_20"+ext4], INPUT["mode1_10_20_error"+ext4], kRed, 25, 1.1, "pl", 1 );
   //PlotData( pt3, INPUT["mode2_10_20"+ext4], INPUT["mode2_10_20_error"+ext4], kBlack, 25, 1.1, "pl", 1 );
   
   //PlotData( x21_arr, y21_arr, y21_err, kBlack, 24, 1.1, "pl", 1 );
   ...
   PlotData( pt4, INPUT["mode1_20_30"+ext1], INPUT["mode1_20_30_error"+ext1], kBlue, 21, 1.1, "pl", 1 );
   PlotData( pt4, INPUT["mode2_20_30"+ext1], INPUT["mode2_20_30_error"+ext1], kRed, 21, 1.1, "pl", 1 );
   PlotData( pt4, INPUT["fit_20_30"+ext1], INPUT["fit_20_30_error"+ext1], kGreen, 34, 1.1, "pl", 1 );

   //PlotData( pt4, INPUT["mode1_20_30"+ext2], INPUT["mode1_20_30_error"+ext2], kRed, 25, 1.1, "pl", 1 );
   //PlotData( pt4, INPUT["mode2_20_30"+ext2], INPUT["mode2_20_30_error"+ext2], kBlack, 25, 1.1, "pl", 1 );

   PlotData( pt4, INPUT["mode1_20_30"+ext3], INPUT["mode1_20_30_error"+ext3], kViolet, 21, 1.1, "pl", 1 );
   PlotData( pt4, INPUT["mode2_20_30"+ext3], INPUT["mode2_20_30_error"+ext3], kMagenta, 21, 1.1, "pl", 1 );
   PlotData( pt4, INPUT["fit_20_30"+ext3], INPUT["fit_20_30_error"+ext3], kOrange, 34, 1.1, "pl", 1 );

   //PlotData( pt4, INPUT["mode1_20_30"+ext4], INPUT["mode1_20_30_error"+ext4], kRed, 25, 1.1, "pl", 1 );
   //PlotData( pt4, INPUT["mode2_20_30"+ext4], INPUT["mode2_20_30_error"+ext4], kBlack, 25, 1.1, "pl", 1 );
   
   //PlotData( x22_arr, y22_arr, y22_err, kBlack, 24, 1.1, "pl", 1 );
   ...
   PlotData( pt5, INPUT["mode1_30_40"+ext1], INPUT["mode1_30_40_error"+ext1], kBlue, 21, 1.1, "pl", 1 );
   PlotData( pt5, INPUT["mode2_30_40"+ext1], INPUT["mode2_30_40_error"+ext1], kRed, 21, 1.1, "pl", 1 );
   PlotData( pt5, INPUT["fit_30_40"+ext1], INPUT["fit_30_40_error"+ext1], kGreen, 34, 1.1, "pl", 1 );

   //PlotData( pt5, INPUT["mode1_30_40"+ext2], INPUT["mode1_30_40_error"+ext2], kRed, 25, 1.1, "pl", 1 );
   //PlotData( pt5, INPUT["mode2_30_40"+ext2], INPUT["mode2_30_40_error"+ext2], kBlack,  25, 1.1, "pl", 1 );

   PlotData( pt5, INPUT["mode1_30_40"+ext3], INPUT["mode1_30_40_error"+ext3], kViolet, 21, 1.1, "pl", 1 );
   PlotData( pt5, INPUT["mode2_30_40"+ext3], INPUT["mode2_30_40_error"+ext3], kMagenta, 21, 1.1, "pl", 1 );
   PlotData( pt5, INPUT["fit_30_40"+ext3], INPUT["fit_30_40_error"+ext3], kOrange, 34, 1.1, "pl", 1 );

   //PlotData( pt5, INPUT["mode1_30_40"+ext4], INPUT["mode1_30_40_error"+ext4], kRed, 25, 1.1, "pl", 1 );
   //PlotData( pt5, INPUT["mode2_30_40"+ext4], INPUT["mode2_30_40_error"+ext4], kBlack,  25, 1.1, "pl", 1 );

   //PlotData( x23_arr, y23_arr, y23_err, kBlack, 24, 1.1, "pl", 1 );
   ...
   PlotData( pt6, INPUT["mode1_40_50"+ext1], INPUT["mode1_40_50_error"+ext1], kBlue, 21, 1.1, "pl", 1 );
   PlotData( pt6, INPUT["mode2_40_50"+ext1], INPUT["mode2_40_50_error"+ext1], kRed, 21, 1.1, "pl", 1 );
   PlotData( pt6, INPUT["fit_40_50"+ext1], INPUT["fit_40_50_error"+ext1], kGreen, 34, 1.1, "pl", 1 );

   //PlotData( pt6, INPUT["mode1_40_50"+ext2], INPUT["mode1_40_50_error"+ext2], kRed, 25, 1.1, "pl", 1 );
   //PlotData( pt6, INPUT["mode2_40_50"+ext2], INPUT["mode2_40_50_error"+ext2], kBlack, 25, 1.1, "pl", 1 );

   PlotData( pt6, INPUT["mode1_40_50"+ext3], INPUT["mode1_40_50_error"+ext3], kViolet, 21, 1.1, "pl", 1 );
   PlotData( pt6, INPUT["mode2_40_50"+ext3], INPUT["mode2_40_50_error"+ext3], kMagenta, 21, 1.1, "pl", 1 );
   PlotData( pt6, INPUT["fit_40_50"+ext3], INPUT["fit_40_50_error"+ext3], kOrange, 34, 1.1, "pl", 1 );

   //PlotData( pt6, INPUT["mode1_40_50"+ext4], INPUT["mode1_40_50_error"+ext4], kRed, 25, 1.1, "pl", 1 );
   //PlotData( pt6, INPUT["mode2_40_50"+ext4], INPUT["mode2_40_50_error"+ext4], kBlack, 25, 1.1, "pl", 1 );

   //PlotData( x24_arr, y24_arr, y24_err, kBlack, 24, 1.1, "pl", 1 );
   ...
   PlotData( pt7, INPUT["mode1_50_60"+ext1], INPUT["mode1_50_60_error"+ext1], kBlue, 21, 1.1, "pl", 1 );
   PlotData( pt7, INPUT["mode2_50_60"+ext1], INPUT["mode2_50_60_error"+ext1], kRed, 21, 1.1, "pl", 1 );
   PlotData( pt7, INPUT["fit_50_60"+ext1], INPUT["fit_50_60_error"+ext1], kGreen, 34, 1.1, "pl", 1 );

   //PlotData( pt7, INPUT["mode1_50_60"+ext2], INPUT["mode1_50_60_error"+ext2], kRed, 25, 1.1, "pl", 1 );
   //PlotData( pt7, INPUT["mode2_50_60"+ext2], INPUT["mode2_50_60_error"+ext2], kBlack, 25, 1.1, "pl", 1 );

   PlotData( pt7, INPUT["mode1_50_60"+ext3], INPUT["mode1_50_60_error"+ext3], kViolet, 21, 1.1, "pl", 1 );
   PlotData( pt7, INPUT["mode2_50_60"+ext3], INPUT["mode2_50_60_error"+ext3], kMagenta, 21, 1.1, "pl", 1 );
   PlotData( pt7, INPUT["fit_50_60"+ext3], INPUT["fit_50_60_error"+ext3], kOrange, 34, 1.1, "pl", 1 );

   //PlotData( pt7, INPUT["mode1_50_60"+ext4], INPUT["mode1_50_60_error"+ext4], kRed, 25, 1.1, "pl", 1 );
   //PlotData( pt7, INPUT["mode2_50_60"+ext4], INPUT["mode2_50_60_error"+ext4], kBlack, 25, 1.1, "pl", 1 );
