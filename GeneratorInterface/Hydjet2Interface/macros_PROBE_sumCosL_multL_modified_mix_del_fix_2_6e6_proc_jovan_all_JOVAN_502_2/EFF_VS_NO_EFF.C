...
void DoText(TString text){
   ...
   TText *t = new TText(2.45,0.13, text);
   //t->SetTextAlign(22);
...
void EFF_VS_NO_EFF(){
   ...
   // 50-60
   document=READFILE("./DATA/n2/50_60.json");
   ...
   document=READFILE("./DATA/n3/50_60.json");
   ...
   ////////////////////////////////////////////////
   //
   cc1->Print("~/www/05-05-2016/hydjetL/4/2/cc1.png");
}
