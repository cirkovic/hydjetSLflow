...
void EFF_VS_NO_EFF_5(const char *s, const char *deta){
   ...
   PlotData( pt, INPUT["mode1_UCC"+ext2], INPUT["mode1_UCC_error"+ext2], kBlue, 21, 1.1, "pl" );
   PlotData( pt, INPUT["mode2_UCC"+ext2], INPUT["mode2_UCC_error"+ext2], kRed, 21, 1.1, "pl" );
   ...
   PlotData( pt, INPUT["mode1_00_05"+ext2], INPUT["mode1_00_05_error"+ext2], kBlue, 21, 1.1, "pl" );
   PlotData( pt, INPUT["mode2_00_05"+ext2], INPUT["mode2_00_05_error"+ext2], kRed, 21, 1.1, "pl" );
   ...
   PlotData( pt, INPUT["mode1_00_10"+ext2], INPUT["mode1_00_10_error"+ext2], kBlue, 21, 1.1, "pl" );
   PlotData( pt, INPUT["mode2_00_10"+ext2], INPUT["mode2_00_10_error"+ext2], kRed, 21, 1.1, "pl" );
   ...
   PlotData( pt, INPUT["mode1_10_20"+ext2], INPUT["mode1_10_20_error"+ext2], kBlue, 21, 1.1, "pl" );
   PlotData( pt, INPUT["mode2_10_20"+ext2], INPUT["mode2_10_20_error"+ext2], kRed, 21, 1.1, "pl" );
   ...
   PlotData( pt, INPUT["mode1_20_30"+ext2], INPUT["mode1_20_30_error"+ext2], kBlue, 21, 1.1, "pl" );
   PlotData( pt, INPUT["mode2_20_30"+ext2], INPUT["mode2_20_30_error"+ext2], kRed, 21, 1.1, "pl" );
   ...
   PlotData( pt, INPUT["mode1_30_40"+ext2], INPUT["mode1_30_40_error"+ext2], kBlue, 21, 1.1, "pl" );
   PlotData( pt, INPUT["mode2_30_40"+ext2], INPUT["mode2_30_40_error"+ext2], kRed, 21, 1.1, "pl" );
   ...
   PlotData( pt, INPUT["mode1_40_50"+ext2], INPUT["mode1_40_50_error"+ext2], kBlue, 21, 1.1, "pl" );
   PlotData( pt, INPUT["mode2_40_50"+ext2], INPUT["mode2_40_50_error"+ext2], kRed, 21, 1.1, "pl" );
   ...
   PlotData( pt, INPUT["mode1_50_60"+ext2], INPUT["mode1_50_60_error"+ext2], kBlue, 21, 1.1, "pl" );
   PlotData( pt, INPUT["mode2_50_60"+ext2], INPUT["mode2_50_60_error"+ext2], kRed, 21, 1.1, "pl" );
